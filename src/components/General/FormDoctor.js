...
export default class FormDoctor extends Component {
    ...
    componentDidMount() {
        if (this.props.data !== undefined) {
            this.setState({
                docID: this.props.data.ID,
                nombre: this.props.data.Name,
                aPaterno: this.props.data.LastName,
                aMaterno: this.props.data.SecondLastName,
                fdn: this.props.data.BirthDate,
                genero: this.props.data.genero,
                especialidad: this.props.data.Speciality,
                cedulaProfesional: this.props.data.ProfessionalKey,
                cedulaEspecialidad: this.props.data.SpecialityKey,
                email: this.props.data.Email,
                telefono: this.props.data.MainPhoneNumber,
                telefonoAdicional: this.props.data.SecondPhoneNumber,
                calle: this.props.data.Street,
                numeroInterior: this.props.data.ExternalCode,
                numeroExterior: this.props.data.InternalCode,
                cp: this.props.data.PostalCode,
                colonia: this.props.data.Suburb,
                ciudad: this.props.data.City,
                estado: this.props.data.State,
                pais: this.props.data.Country,
                informacionAdicional: this.props.data.ExternalInformation
            });
        }
    }
                ...
                <div className="pl-lg-4">
                    <div className=" p-3">
                        <div className="form-group">
                            ...
                            <form>
                                <div className="row">
                                    <input name="docID" id="docID" value={this.state.docID} />
